            ...
            return(
                <>           
                    ...
                    <div className='text-center'>
                        <button onClick={() => setAddOne(true)} className='active:bg-gray-500 border-1 rounded px-4 cursor-pointer m-5'>Agregar Mascota</button>
                    </div>

                    {addOne && (
                        <div className='text-center'>
                            <h1>Please add yout pet here</h1>
                            <SignUpForm /> 
                        </div>
                    )}
